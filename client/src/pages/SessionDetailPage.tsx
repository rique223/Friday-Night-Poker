...
export default function SessionDetailPage() {
    ...
    const handleCredit = async (payload: {
        providerId: number;
        receiverId: number;
        amount: number;
    }) => {
    ...
    return (
        <div className="max-w-4xl mx-auto p-6 space-y-6">
            ...
            <section className="card p-5">
                ...
                <div className="grid gap-2">
                    {displayedPlayers.map(player => (
                        <PlayerCard key={player.id} player={player} onCashOut={setCashOutPlayer} />
                    ))}
                </div>
            </section>
            ...
            >
                {cashOutPlayer && <CashOutForm onSubmit={handleCashOut} player={cashOutPlayer} />}
            </Modal>
